  ...
  <LegalPageLayout
    ...
    sections={[
      ...
      { heading: "5. How to Request a Refund", content: [
        "To request a refund, email support@abroadmantra.com with your full name, service agreement reference number, reason for the refund request, and any supporting documentation. We will review your request within 5 business days.",
      ]},
      ...
      { heading: "7. Disputes", content: [
        "If you disagree with a refund decision, you may escalate the matter by writing to support@abroadmantra.com. We aim to resolve all disputes within 15 business days.",
      ]},
